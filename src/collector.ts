...
export let useToHashMap: UseToHashMap = <E, K, V>(keyExtractor: Functional<E, K> | BiFunctional<E, bigint, K>, valueExtractor: Functional<E, V> | BiFunctional<E, bigint, V> = (element: E): V => element as unknown as V): Collector<E, HashMap<K, V>, HashMap<K, V>> => {
    if(isFunction(keyExtractor) && isFunction(valueExtractor)){
