...
export const validate: <T>(t: MaybeInvalid<T>) => t is T = <T>(t: T | null | undefined): t is T => {
    return t !== null && t !== (void 0);
};

export const invalidate: <T>(t: MaybeInvalid<T>) => t is (null | undefined) = <T>(t: T | null | undefined): t is (null | undefined) => {
    return t === null || t === undefined;
};

export const isBoolean: <T>(t: unknown) => t is boolean = <T>(t: unknown): t is boolean => {
    return typeof t === "boolean";
};
export const isString: <T>(t: unknown) => t is string = <T>(t: unknown): t is string => {
    return typeof t === "string";
};
export const isNumber: <T>(t: unknown) => t is number = <T>(t: unknown): t is number => {
    return typeof t === "number";
};
export const isFunction: <T>(t: unknown) => t is Function = <T>(t: unknown): t is Function => {
    return typeof t === "function";
};
export const isObject: <T>(t: unknown) => t is object = <T>(t: unknown): t is object => {
    return typeof t === "object" && t !== null;
};
export const isSymbol: <T>(t: unknown) => t is symbol = <T>(t: unknown): t is symbol => {
    return typeof t === "symbol";
};
export const isBigint: <T>(t: unknown) => t is bigint = <T>(t: unknown): t is bigint => {
    return typeof t === "bigint";
};
export const isIterable: <T>(t: unknown) => t is Iterable<unknown> = <T>(t: unknown): t is Iterable<unknown> => {
    if (isObject(t)) {
...
export const fill = <E>(element: E | Supplier<E>, count: bigint): Semantic<E> => {
    return new Semantic<E>((accept, interrupt) => {
...
export const from = <E>(iterable: Iterable<E>): Semantic<E> => {
...
export const range = (start: number | bigint, end: number | bigint, step: number | bigint = 1): Semantic<number> | Semantic<bigint> => {
